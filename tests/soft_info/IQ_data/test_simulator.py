...
#     def test_constructor(self, mock_get_KDEs, mock_get_repcode_layout, mock_get_repcode_IQ_map):
...
#         # Assertions
#         self.assertEqual(simulator.d, distance)
#         self.assertEqual(simulator.T, rounds)
