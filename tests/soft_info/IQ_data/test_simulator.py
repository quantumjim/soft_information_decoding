...
class TestRepCodeIQSimulator:
    ...
    def test_init(self, mock_find_closest_calib_jobs, mock_get_calib_jobs, mock_load_calibration_memory, 
                  mock_get_KDEs, mock_get_repcode_IQ_map, mock_get_repcode_layout, mock_get_backend):
        # Mock values
        mock_provider = Mock()
        mock_backend = Mock()
